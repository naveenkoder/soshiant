...
<div class="container">
    ...
    <script>
        ...
        async function getPredictedData() {
            await fetch(`http://localhost/soshiane/admin/api/v1/routes_data.php?action=get`)
                .then((res) => res.json())
                .then((res) => {
        ...
        async function getEvaluation() {
            await fetch(`http://localhost/soshiane/admin/api/v1/routes_data.php?action=get_evaluation`)
        ...
        async function getTopTen() {
            await fetch(`http://localhost/soshiane/admin/api/v1/top_ten.php?action=get_all`)
                .then(async (res) => await res.json())
                .then((res) => {
                    console.log(res);
