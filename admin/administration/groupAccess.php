  ...
  <div class="col-md-6">
    <div class="row">
      <div class="col-md-12 add-margin">
        ...
        <select class="form-control" id="user" onchange="changeUser()" multiple style="height:400px;">
          <option value="0">none</option>
          <?php
          $users = getAllUsers();
          usort($users, "comparatorFunc"); 
          function comparatorFunc( $x, $y) {
              return strnatcmp(strtolower($x['user_name']), strtolower($y['user_name']));
          }
...
<script>
  ...
  function bootstrap() {
    ...
    $("#submit").on("click", () => {
      ...
      const selectedUser = []
      $("#user option:selected").each(function(e) {
        console.log(this);
        console.log(e);
      ...
      formData.append("action", "grouppush");
