                    ...
                    <div class="form-group buttons-group">
                        ...
                        <div class="col-md-12">
                            <Button class="btn btn-info"
                                onclick="downloadCSV('TIME,ACTUALVALUE,PREDICTEDVALUE1,PREDICTEDVALUE2,PREDICTEDVALUE3,TITLE', 'filename-[unique_id]-avg-[average_accuracy]-cl-[confidence_level]')">
...
<script>
    class ImportPageProperties {
        ...
        autoParser(data, index) {
            ...
            else if (this.dataType(data) === "Average") this.AverageParser(data, index)
            else 
    ...
    class FormatValidator {
        ...
        static isActualValue(header, content) {
            const items = ["TIME", "ACTUALVALUE", "PREDICTEDVALUE1", "PREDICTEDVALUE2", "PREDICTEDVALUE3", "TITLE"];
    ...
    function getRoutes() {
        fetch("https://soshianest.rapidekops.us/admin/api/v1/get_menu_tree.php?Key=text&type=json")
            .then((res) => res.json())
            .then(res => {
            ...
            if (page.dataType(data) === "Prediction")
                await importPrediction(data, index)
                    .then(res => {
                        // console.log(res)
                        if (!res) {
                            failedFiles.push(page.fileName[index]);
                        }
                    })
                    .catch((error) => {
                        console.log(error);
    ...
    function sendAverageRequest(formData) {
        return new Promise((resolve, reject) => {
            $("#submit").attr("disabled", "disabled")
            fetch("https://soshianest.rapidekops.us/admin/api/v1/routes.php", {
                body: formData,
                method: "POST"
            })
                .then(async (res) => {
    ...
    function sendRequest(formData) {
        ...
        return new Promise((resolve, reject) => {
            $("#submit").attr("disabled", "disabled")
            fetch("https://soshianest.rapidekops.us/admin/api/v1/routes_data.php", {
                body: formData,
                method: "POST"
            })
                .then(async (res) => {
