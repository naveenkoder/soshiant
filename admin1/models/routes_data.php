...
function createRouteData($data)
{
    ...
    $sql = "INSERT INTO arioo_routes_data (year, period, value, more_info, unique_id, is_real,average_accuracy, confidence_level, create_time) VALUES ($year, '$period', '$value', '$more_info', '$unique_id', $is_real, $average_accuracy, $confidence_level, $create_time)";
    $result = dbquery($sql);
    if ($result) {
        return true;
    } else {
