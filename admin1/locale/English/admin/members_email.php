...
$locale['email_create_message'] = "Hello [USER_NAME],<br/><br/>
Your account at [SITENAME] has been created.<br/>You can now log in using the following details: <br/> 
Link: <a href='https://soshianest.ai/'>soshianest.ai</a><br/>
Username: [USER_NAME]<br/>Password: [PASSWORD]<br/><br/>Regards,<br/>[SITEUSERNAME]";
